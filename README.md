...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-09 10:42`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d4aab20f-eb40-4305-aa5a-f279c3805744.git
$ cd d4aab20f-eb40-4305-aa5a-f279c3805744
```
